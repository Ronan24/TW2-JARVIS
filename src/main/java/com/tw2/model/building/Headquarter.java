...
public class Headquarter extends UnlockBuilding<BuildingName> {
    ...
    public Headquarter(boolean isConstruct, int level, int levelUpGoing) {
        ...
        this.unlockList = new EnumMap<>(BuildingName.class);

        this.unlockList.put(BuildingName.BARRACKS, 2);
        this.unlockList.put(BuildingName.STATUE, 3);
        this.unlockList.put(BuildingName.HOSPITAL, 4);
        this.unlockList.put(BuildingName.WALL, 5);
        this.unlockList.put(BuildingName.MARKET, 6);
        this.unlockList.put(BuildingName.TAVERN, 8);
//        this.unlockList.put(BuildingName.ACADEMY, 20);
//        this.unlockList.put(BuildingName.HALL_OF_ORDERS, 25);
