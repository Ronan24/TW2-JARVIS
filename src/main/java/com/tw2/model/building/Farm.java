...
public class Farm extends Building {
    ...
    public Farm(boolean isConstruct, int level, int levelUpGoing) {
        ...
        this.maxPopulationList = new ArrayList<>();

        this.maxPopulationList.add(240);
        this.maxPopulationList.add(281);
        this.maxPopulationList.add(330);
        this.maxPopulationList.add(386);
        this.maxPopulationList.add(453);
        this.maxPopulationList.add(531);
        this.maxPopulationList.add(622);
        this.maxPopulationList.add(729);
        this.maxPopulationList.add(855);
        this.maxPopulationList.add(1002);
        this.maxPopulationList.add(1175);
        this.maxPopulationList.add(1377);
        this.maxPopulationList.add(1614);
        this.maxPopulationList.add(1891);
        this.maxPopulationList.add(2217);
        this.maxPopulationList.add(2598);
        this.maxPopulationList.add(3046);
        this.maxPopulationList.add(3570);
        this.maxPopulationList.add(4184);
        this.maxPopulationList.add(4904);
        this.maxPopulationList.add(5748);
        this.maxPopulationList.add(6737);
        this.maxPopulationList.add(7897);
        this.maxPopulationList.add(9256);
        this.maxPopulationList.add(10849);
        this.maxPopulationList.add(12716);
        this.maxPopulationList.add(14904);
        this.maxPopulationList.add(17469);
        this.maxPopulationList.add(20476);
        this.maxPopulationList.add(24000);

    }

    public int getMaxPopulation() {
        return this.maxPopulationList.get(getLevel() - 1);
    }
}
